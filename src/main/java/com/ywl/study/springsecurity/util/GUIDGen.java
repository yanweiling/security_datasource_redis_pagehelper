package com.ywl.study.springsecurity.util;
/**
 * GUID
 ...
 * 01/20/05 -- Rename RandomGUID to GUIDGen, change to singleton mode
...
public class GUIDGen extends Object {
    ...
    public static String getGUID() {
        return new GUIDGen().valueAfterMD5;
    }

    public static String getGUID(boolean secure) {
        return new GUIDGen(secure).valueAfterMD5;
    }

    /**
     * 取得GUID
     * @return 36位GUID字符串, 格式为xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
     */
    public static String getGUIDString() {
        return new GUIDGen().toString();
    }

    public static String getGUIDString(boolean secure) {
        return new GUIDGen(secure).toString();
    }
     ...
     */
    private GUIDGen(boolean secure) {
    ...
    public static void main(String args[]) {
        for (int i=0; i< 100; i++) {
            System.out.println(GUIDGen.getGUIDString(true));
        }
    }
}
